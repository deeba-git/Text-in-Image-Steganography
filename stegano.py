...
Label(root, text="The Science Of Hiding Information!", bg="#EEEEDF", fg="black",
      font=("Lucida Handwriting", 14), wraplength=500).place(x=30, y=145)
...
def encode_window():
    ...
    Label(encode_wn, text='Hide data in Image', font=(
        "Bookman Old Style", 15), bg='#CDCDC8').place(x=220, rely=0)
    ...
    Button(encode_wn, text='Encode the Image', font=('Bookman Old Style', 12), bg='#EEEED5', command=lambda: main_encode(
        img_path.get(), text_to_be_encoded.get(), after_save_path.get())).place(x=220, y=170)
...
def decode_window():
    ...
    Label(decode_wn, text='Unhide data from Image', font=(
        "Bell MT", 15), bg='#CDCDC8').place(x=200, rely=0)
...
Button(root, text="Encode", width=15, height=1, font="Georgia 14 bold",
       bg="#EEEED5", command=encode_window).place(x=120, y=200)
Button(root, text="Decode", width=15, height=1, font="Georgia 14 bold",
       bg="#EEEED5", command=decode_window).place(x=120, y=250)
